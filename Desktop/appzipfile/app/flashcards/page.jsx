    ...
    return (
      <div className="min-h-screen bg-[#050505]">
        ...
        <div className="max-w-2xl mx-auto px-4 py-8">
          ...
          {/* Flashcard */}
          <div
            className="bg-[#0d0d15] border border-[#1a1a2a] rounded-2xl p-8 min-h-[300px] flex flex-col cursor-pointer transition-all hover:border-purple-500/30"
            onClick={() => setShowAnswer(!showAnswer)}
          >
            <div className="flex items-center gap-2 mb-4">
              <span className="px-2 py-1 bg-purple-500/20 text-purple-400 text-xs rounded">{card.subject}</span>
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-4 gap-3">
                ...
                <button
                  ...
                  className="p-3 bg-purple-500/20 border border-purple-500/30 rounded-xl text-purple-400 hover:bg-purple-500/30 transition-colors"
                >
          ...
          <>
            ...
            <div className="space-y-3">
              {filteredCards.map((card) => (
                <div
                  key={card.id}
                  className="bg-[#0d0d15] border border-[#1a1a2a] rounded-xl p-4 hover:border-purple-500/30 transition-colors"
                >
